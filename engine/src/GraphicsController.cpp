...
namespace engine::graphics {
    void GraphicsController::initialize() {
        ...
        RG_GUARANTEE(
            ...
            "ImGUI failed to initialize for OpenGL");
    ...
    void GraphicsController::draw_skybox(
    ...
    void GraphicsController::bind_point_shadow_map(
        int32_t texture_unit,
        uint32_t depth_cubemap) {
        OpenGL::bind_cubemap_texture(
            texture_unit,
            depth_cubemap);
    }
} // namespace engine::graphics
